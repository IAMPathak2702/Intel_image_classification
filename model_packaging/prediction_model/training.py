...
from model_packaging.prediction_model.processing.data_handeling import load_dataset ,save_model
from model_packaging.prediction_model.pipeline import create_resnet_model
from model_packaging.prediction_model.processing.preprocessing import ModelCallbacks
...
def perform_training():
    ...
    # Train the modelprediction_model.
